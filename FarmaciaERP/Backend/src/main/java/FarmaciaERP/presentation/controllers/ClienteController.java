...
public class ClienteController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Customer> actualizar(@PathVariable Long id, @RequestBody Customer customer) {
        try {
            Customer customerActualizado = actualizarClienteUseCase.ejecutar(id, customer);
