...
//
//    @Override
//    public Optional<Customer> findById(Long distritoId) {
//        return jpaRepository.findById(distritoId)
...
//
//    @Override
//    public void deleteById(Long distritoId) {
//        jpaRepository.deleteById(distritoId);
//    }
//
//    @Override
//    public boolean existById(Long distritoId) {
//        return jpaRepository.existsById(distritoId);
//    }
//
//    @Override
...
//        return jpaRepository.findByNombres(nombres.getValor())
//                .stream()
//                .map(CustomerMapper::ToDomain)
//                .toList();
//    }
...
//        return jpaRepository.findByTipoSeguro(insuranceType.name())
//                .stream()
//                .map(CustomerMapper::ToDomain)
//                .toList();
//    }
