...
/**
 * FI-AP.02 Fase 02 - paso 2.2.2: ¿Se Absorbe la Diferencia Comercial? — No,
 * reabrir para una nueva ronda de negociación.
 */
@Service
public class ReabrirNegociacionUseCase {

    private final IDisputaComercialRepository disputaComercialRepository;

    public ReabrirNegociacionUseCase(IDisputaComercialRepository disputaComercialRepository) {
