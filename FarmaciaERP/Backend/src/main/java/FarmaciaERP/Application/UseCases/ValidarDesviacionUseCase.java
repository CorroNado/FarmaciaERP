...
/**
 * FI-AP.02 Fase 02 - paso 2.1.3: Revisión y Validación de la Desviación.
 */
@Service
public class ValidarDesviacionUseCase {

    private final IDisputaComercialRepository disputaComercialRepository;

    public ValidarDesviacionUseCase(IDisputaComercialRepository disputaComercialRepository) {
