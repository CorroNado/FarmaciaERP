...
/**
 * FI-AP.02 Fase 02 - paso 2.2.1: Apertura de Disputa con Ejecutivo de
 * Droguería / Laboratorio (abre una nueva ronda de negociación).
 */
@Service
public class AbrirNegociacionUseCase {

    private final IDisputaComercialRepository disputaComercialRepository;

    public AbrirNegociacionUseCase(IDisputaComercialRepository disputaComercialRepository) {
