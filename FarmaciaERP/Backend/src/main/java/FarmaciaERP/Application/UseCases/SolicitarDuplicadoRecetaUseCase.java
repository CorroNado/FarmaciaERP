...
/**
 * FI-AR · Fase 02 - 2.3.3 Subsanación de Recetas y Solicitud de Duplicados
 * a Sucursal / Médico tratante (RN-AR2-01).
 */
@Service
public class SolicitarDuplicadoRecetaUseCase {

    private final IContabilizacionARRepository contabilizacionARRepository;

    public SolicitarDuplicadoRecetaUseCase(IContabilizacionARRepository contabilizacionARRepository) {
    ...
    public ContabilizacionARResponse ejecutar(Long id) {
        ...
        contabilizacion.solicitarDuplicadoReceta();
