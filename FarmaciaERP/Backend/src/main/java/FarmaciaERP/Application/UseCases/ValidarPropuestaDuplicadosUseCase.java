...
/**
 * FI-AP.06 Fase 06 - paso 6.2: Validar Propuesta de Duplicados / Bloqueos
 * (Comprador / Category Manager).
 */
@Service
public class ValidarPropuestaDuplicadosUseCase {

    private final IDispersionBancariaCierreRepository dispersionBancariaCierreRepository;

    public ValidarPropuestaDuplicadosUseCase(IDispersionBancariaCierreRepository dispersionBancariaCierreRepository) {
    ...
    public DispersionBancariaCierreResponse ejecutar(Long id) {
        ...
        dispersion.validarPropuestaDuplicadosBloqueos();
